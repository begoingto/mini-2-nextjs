        ...
        <>
            <div className="flex justify-center relative">
                <label htmlFor="file" className={"hover:cursor-pointer"}>
                    ...
                    <Image unoptimized width={100} height={100} className="w-96 h-52 object-contain rounded border-2 border-blue-700 hover:border-green-700" src={ previewImg ? previewImg : thumbnailDefault} alt="a large avatar" />
                </label>
            </div>
            <input
                type="file"
