    ...
    return (
        <Link href={`/peoples/${id}`} className="flex flex-col iteclassNamenter pb-10 text-center">
            <div className="flex justify-center">
                <Image unoptimized width={100} height={100} className="w-32 h-32 border-4 border-pink-500 mb-3 rounded-full shadow-lg object-cover" src={ image ? image : "https://bit.ly/44Oio4m"} alt="Bonnie image"/>
            </div>
